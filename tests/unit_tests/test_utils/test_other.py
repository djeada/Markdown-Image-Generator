...
def test_valid_hex_color_codes():
    assert hex_to_rgba("#FF0000") == (255, 0, 0)
    assert hex_to_rgba("#00FF00") == (0, 255, 0)
    assert hex_to_rgba("#0000FF") == (0, 0, 255)
    assert hex_to_rgba("#FFFFFF") == (255, 255, 255)
    assert hex_to_rgba("#000000") == (0, 0, 0)
    assert hex_to_rgba("#123456") == (18, 52, 86)
